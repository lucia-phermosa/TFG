...
int CommandParser::parseinputdata(const char* label) {
  ...
  else if (0 == std::strcmp(label, "LG")){
    std::sscanf(msg, "%d", &leg_id);
    return 6;
  }
  else if (0 == std::strcmp(label, "MV")){
    return 7;
  }
  ...
  else if (0 == std::strcmp(label, "OZ")){
    std::sscanf(msg, "%f", &osc_amp);
    return 18;
  }
  else if (0 == std::strcmp(label, "OW")){
    std::sscanf(msg, "%f", &osc_w);
    return 19;
  }
  else if (0 == std::strcmp(label, "OP")){
    std::sscanf(msg, "%f", &osc_phi);
    return 20;
  }
  else if (0 == std::strcmp(label, "OX")){
    std::sscanf(msg, "%f", &oscX_amp);
    return 23;
  }
  else if (0 == std::strcmp(label, "OY")){
    std::sscanf(msg, "%f", &oscY_amp);
    return 24;
  }
  else if (0 == std::strcmp(label, "RY")){
    return 21;
  }
  else if (0 == std::strcmp(label, "TEST")){
    return 22;
  }
